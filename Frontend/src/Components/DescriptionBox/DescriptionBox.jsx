  ...
  return (
    <div className='descriptionbox'>
        ...
        <div className="descriptionbox-description">
            ...
            <p>E-commerce websites typically display products or sevices along with detailed descriptions, images, prices, and any available variations (e.g sizes, colours etc). Each product usually has its own dedicated page with relevant information.</p>
        </div>
    </div>
  )
}
